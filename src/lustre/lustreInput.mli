...
val of_file :
  bool -> string ->
  ((LustreNode.t SubSystem.t list * LustreGlobals.t * LustreAst.t * TypeCheckerContext.tc_context * LustreNodeGen.sv_source StateVar.StateVarHashtbl.t) option, [> error]) result
