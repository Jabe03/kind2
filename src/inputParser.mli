...
val read_file: ?only_inputs:bool -> string list -> string -> LustreAst.lustre_type HString.HStringMap.t -> ((assignment_lhs * (Term.t list)) list * string HString.HStringMap.t list)
...
val read_json_file: ?only_inputs:bool -> string list -> string -> LustreAst.lustre_type HString.HStringMap.t  -> ((assignment_lhs * (Term.t list)) list * string HString.HStringMap.t list)
